 ...
 */
package com.cisco.odl.soam.cli.commands;

import org.apache.karaf.shell.commands.Command;
import org.apache.karaf.shell.commands.Option;
import org.apache.karaf.shell.console.AbstractAction;
import com.cisco.odl.soam.cli.api.SoamCliCommands;
...
public class SoamCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(SoamCliTestCommand.class);
    protected final SoamCliCommands service;

    public SoamCliTestCommand(final SoamCliCommands service) {
