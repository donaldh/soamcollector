...
public abstract class SoamDataTreeChangeListener<D extends DataObject> implements DataTreeChangeListener<D>, AutoCloseable {

    protected DataBroker dataBroker;

    public SoamDataTreeChangeListener(final DataBroker dataBroker) {
